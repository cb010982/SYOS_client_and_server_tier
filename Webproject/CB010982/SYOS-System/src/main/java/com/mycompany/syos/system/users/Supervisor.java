...
public class Supervisor implements User {
    ...
    public Supervisor(UserModel userModel) {
        this.userModel = userModel;
    }

    @Override
    public void login() {
        System.out.println(userModel.getUsername() + " (Supervisor) logged in.");
    }

    @Override
    public void signUp() {
        System.out.println("Supervisor signed up with email: " + userModel.getEmail());
    }
